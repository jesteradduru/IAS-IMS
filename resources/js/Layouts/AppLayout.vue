...
<template>
    <div>
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <div class="flex flex-col justify-center">
                                    <div class="font-black text-xl">IAS Inspection and Monitoring System</div>
                                </div>
                            </div>
                        </div>
        ...
        <main class="md:grid grid-cols-12 gap-5">
            <section v-if="!route().current('profile.show')" class="col-span-2">
                <SideNavigation />
            </section>
            <section
                :class="{ 'col-span-12': route().current('profile.show') , 'col-span-10': !route().current('profile.show')}">
                
                <div class="text-2xl mt-4 font-bold">
                    <slot name="page-title" />
                </div>
                <div v-if="$page.props.ziggy.flash.success"
                    class="p-2 border rounded-md border-green-500 bg-green-100 shadow-md mb-2">
