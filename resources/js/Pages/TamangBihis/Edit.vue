                    ...
                    <div class="col-span-6">
                        ...
                        <div class="mb-2">
                            <div v-for="violation in form.infractions" class="ms-2 flex gap-4 text-gray-600">
                                <div>{{ violation.violation }} <span v-if="violation.other_infraction"> | {{
                                    violation.other_infraction }}</span></div>
...
const form = useForm({
    inspecting_office_id: props.tamang_bihis.inspecting_office_id,
    infraction_id: null,
    infractions: props.infraction.map(i => ({ violation: i.violation.name, id: i.violation.id, other_infraction: i.other_infraction })),
    date_time: props.tamang_bihis.date_time,
    fullname: props.tamang_bihis.fullname,
    unit_id: props.tamang_bihis.unit_id,
    status: props.tamang_bihis.status,
...
const update = () => form.put(route('tamang_bihis.update', { tamang_bihis: props.tamang_bihis.id }));
