<template>
    <AppLayout title="Proactive | Create">
        <div class="box mx-4">
            <div class="text-2xl mb-2">Absent Personnel | Edit</div>
            <form @submit.prevent="update">
                <div class="grid grid-cols-6 gap-4">
                    ...
                    <div class="col-span-6">
                        ...
                        <textarea name="" id="" cols="30" rows="3" v-model.number="form.action_taken" class="input-text" />
                    ...
                    <div class="col-span-6 flex gap-2">
                        <Link class="btn-normal" :href="route('absent_personnel.index')" type="button">Back</Link>
...
const form = useForm({
    ...
    action_taken: props.data.action_taken,
    status: props.data.status,
});

const update = () => form.put(route('absent_personnel.update', {absent_personnel: props.data.id}));
