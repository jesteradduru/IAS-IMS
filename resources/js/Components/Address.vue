<template>
    ...
    <div class="col-span-3">
        ...
        <select class="input-select" name="" v-model="form.province" id="" @change="onChangeProvince">
    ...
    <div class="col-span-3">
        ...
        <select class="input-select" name="" v-model="form.municipality" id="" @change="onChangeMunicipality">
    ...
    <div class="col-span-3">
        ...
        <select class="input-select" name="" v-model="form.barangay" id="">
